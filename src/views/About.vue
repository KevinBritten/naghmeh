<template>
  <div class="about-page">
    <scroll-area :title="'About'">
      ...
      <p>
        After years on the road and a few international collaborations, Naghmeh
        moved back to her hometown of Montreal to focus on the next step of her
        career. She assembled a band, performed in every corner of the city, and
        recorded, co-produced and released her self-titled debut album in 2019.
        Her sound is authentic in its delivery and blends different eras of
        music into a punky, alternative, pop rock. With throaty melodies,
        satirical lyrics and a touch of triumphant rock n' roll, Naghmeh's goal
      ...
      <p class="about-page__last-paragraph">
        ...
        above the prejudices she’s faced. Her story is inspiring and has just
        begun. Naghmeh is on a mission to bring love and justice to the world
        and is doing so through the art of music. She’s dedicating her efforts
        to produce her next musical offering which is set to release in 2021.
        Stay tuned for Queen Of Hearts!
      </p>
    </scroll-area>
  </div>
</template>
...
export default {
  components: { ScrollOverlay, ScrollArea }
};
</script>
<style scoped>
* {
